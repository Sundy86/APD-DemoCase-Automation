package com.cccis.testcase.demo190_194;
...
public class Case191 extends CommonTest {
    LoginPage loginPage;
    ...
    public void estimateDefineAndRepair(String vinCode, String question, String answer, String vehicleSubModelName) {
        SeleniumUtil.log(log,"--------------------------VIN二步到款 case 191--------------------------");
        estimateItemPage.setFirstPartyVehicleInfo2(vinCode);
        estimateItemPage.selectConfigQuestion(question, answer);
        Assert.assertEquals(vehicleSubModelName, estimateItemPage.getVehicleSubModelName());
