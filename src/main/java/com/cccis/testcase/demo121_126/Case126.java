package com.cccis.testcase.demo121_126;
...
public class Case126 extends CommonTest {
    LoginPage loginPage;
    ...
    public void addPart(String flag, String operationType, String partName) {
        SeleniumUtil.log(log,"----同一配件不可重复赔付 case110----");
        ...
        if (flag.equals("2") ) {
            ...
            estimateItemPage.editItem(Integer.parseInt(flag),6,"20");
        }
    }
