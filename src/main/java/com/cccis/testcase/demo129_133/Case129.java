package com.cccis.testcase.demo129_133;
...
public class Case129 extends CommonTest {
    LoginPage loginPage;
    ...
    public void addPart(String row, String operationType, String partName) {
        SeleniumUtil.log(log,"----车型配置与辅料的关系 case129----");

        estimateItemPage.clickMaterialDataTab();
        Assert.assertFalse(estimateItemPage.materialDataIsExist(partName), "辅料tab中不存在辅料");
        SeleniumUtil.log(log,"----自定义辅料 助力转向油 ");
