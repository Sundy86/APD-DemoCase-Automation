...
public class Case156 extends CommonTest {
    LoginPage loginPage;
    ...
    public void addPart(String partName ) {
        SeleniumUtil.log(log,"----通过配件名称搜索配件" + partName + "，低配高赔 case156----");
        String[] parts = partName.split(",");
        for (String s: parts){
            Assert.assertFalse(estimateItemPage.partTreePartIsExist(s), "无" + partName);
        }
    }
