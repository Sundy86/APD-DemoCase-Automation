...
public class Case72 extends CommonTest {
    LoginPage loginPage;
    ...
    public void addPart(String operationType, String partName, String categoryName) {
        SeleniumUtil.log(log,"----通过配件名称搜索配件" + partName + "，更换的配件需与车辆损失部位相符 case72----");

        SeleniumUtil.log(log,"----点选添加换件 散热器");
