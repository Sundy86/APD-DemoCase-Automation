package com.cccis.testcase.demo157_161;
...
public class Case157 extends CommonTest {
    LoginPage loginPage;
    ...
    public void addPart(String partName ) {
        SeleniumUtil.log(log,"----通过配件名称搜索配件" + partName + "，低配高赔 case157----");
        SeleniumUtil.log(log,"----点选添加换件 天窗玻璃");
