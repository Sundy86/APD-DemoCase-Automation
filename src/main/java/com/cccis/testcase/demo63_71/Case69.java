package com.cccis.testcase.demo63_71;
...
public class Case69 extends CommonTest {
    LoginPage loginPage;
    ...
    public void addPart(String manualFlag, String row, String operationType, String categoryName, String columnField1, String partName, String columnField2, String afterPrice) {
        SeleniumUtil.log(log,"----同一配件不可重复赔付 case63----");
