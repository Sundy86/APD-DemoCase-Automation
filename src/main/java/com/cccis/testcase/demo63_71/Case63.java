...
public class Case63 extends CommonTest {
    LoginPage loginPage;
    ...
    public void addPart(String manualFlag, String row, String operationType, String columnField1, String partName, String columnField2, String afterPrice) {
