...
public class Case102 extends CommonTest {
    LoginPage loginPage;
...
//        estimateItemPage.partTreeClose();
    ...
    public void addPart(String operationType, String partName, String aliasName) {
        SeleniumUtil.log(log,"----通过配件名称搜索配件" + partName + "，配件是否可维修，可进行何种维修操作 case90----");
        SeleniumUtil.log(log,"----点选添加换件  发动机罩");
        estimateItemPage.addPartByOperatorByName(operationType, partName, aliasName);
    ...
    public void preAudit(String partName, String tipVal ) {
