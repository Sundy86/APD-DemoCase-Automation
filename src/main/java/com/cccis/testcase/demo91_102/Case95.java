...
public class Case95 extends CommonTest {
    LoginPage loginPage;
...
//        estimateItemPage.partTreeClose();
    ...
    public void addPart(String operationType, String partName) {
        SeleniumUtil.log(log,"----通过配件名称搜索配件" + partName + "，配件是否可维修，可进行何种维修操作 case95----");
        SeleniumUtil.log(log,"----点选添加换件  散热器");
        estimateItemPage.addPartByOperatorByCategory(operationType, partName, "冷却系");
