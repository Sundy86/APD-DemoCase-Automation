package com.cccis.testcase.demo103_109;
...
public class Case105 extends CommonTest {
    LoginPage loginPage;
    ...
    public void addPart(String partName, String operationType1, String categoryName, String operationType2) {
        SeleniumUtil.log(log,"----同一配件不可重复赔付 case105----");

        SeleniumUtil.log(log,"----点选添加换件");
        estimateItemPage.addPartByOperatorByCategory(operationType1, partName, categoryName);
//        estimateItemPage.clickAlertCancel();
    ...
    public void preLock(String tipVal ) {
        Assert.assertEquals(estimateItemPage.getPromptAlertText(), tipVal);
        estimateItemPage.clickAlertCancel();
    }
