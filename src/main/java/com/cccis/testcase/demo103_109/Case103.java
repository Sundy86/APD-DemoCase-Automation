...
public class Case103 extends CommonTest {
    LoginPage loginPage;
    ...
    public void addPart(String manualFlag, String row, String operationType, String columnField, String partName) {
        SeleniumUtil.log(log,"----同一配件不可即换又维修 case103----");
        ...
        if (manualFlag.equals("0")) {
            ...
            if (columnField.equals("项目名称")) {
                column = 4;
            }
            estimateItemPage.customAddItem(Integer.parseInt(row), column, operationType, partName);
        }
    }
