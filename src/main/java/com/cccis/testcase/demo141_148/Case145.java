package com.cccis.testcase.demo141_148;
...
public class Case145 extends CommonTest {
    LoginPage loginPage;
    ...
    public void addPart(String row, String partName, String materialQuantity) {
        SeleniumUtil.log(log,"----辅料的用量与价格均应低于限制 case141----");

        SeleniumUtil.log(log,"----点选添加 发动机油");
        estimateItemPage.addMaterialData(partName);

        estimateItemPage.partTreeClose();
        estimateItemPage.editItem(Integer.parseInt(row), 3, materialQuantity);
