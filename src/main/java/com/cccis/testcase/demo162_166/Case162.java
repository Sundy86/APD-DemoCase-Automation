...
public class Case162 extends CommonTest {
    LoginPage loginPage;
    ...
    public void addPart(String flag, String partName, String operationType, String categoryName) {
        ...
        if (flag.equals("1") || flag.equals("2") ) {
            SeleniumUtil.log(log,"----点选添加换件 前保险杠外皮 后保险杠外皮 车顶板");
...
//                estimateItemPage.addPartByOperatorByName(operationType,partName);
//                estimateItemPage.partTreeClose();
//                estimateItemPage.editItem(row,12,"10");
//                estimateItemPage.partTreeOpen();
//                break;
//            case 2:
...
//                break;
//            case 7:
//                SeleniumUtil.log(log,"----点选添加换件 车顶板");
//                estimateItemPage.addPartByOperatorByName(operationType,partName);
//                break;
//            case 3:
//                SeleniumUtil.log(log,"----点选添加换件 左前翼子板");
//                estimateItemPage.addPartByOperatorByCategory(operationType,partName,categoryName);
//                break;
//            case 4:
//                SeleniumUtil.log(log,"----点选添加换件 右前翼子板");
//                estimateItemPage.addPartByOperatorByCategory(operationType,partName,categoryName);
//                break;
//            case 5:
//                SeleniumUtil.log(log,"----点选添加换件 左前车门");
//                estimateItemPage.addPartByOperatorByCategory(operationType,partName,categoryName);
//                break;
//            case 6:
//                SeleniumUtil.log(log,"----点选添加换件 右前车门");
//                estimateItemPage.addPartByOperatorByCategory(operationType,partName,categoryName);
//                break;
//        }
    }
