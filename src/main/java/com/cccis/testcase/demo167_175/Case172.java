...
public class Case172 extends CommonTest {
    LoginPage loginPage;
    ...
    public void addPart(String flag, String partName, String operationType,String category) {
        ...
        if (flag.equals("2")) {
            SeleniumUtil.log(log,"----点选添加换件  左后车门 ");
            estimateItemPage.clickPartDataTab();
            estimateItemPage.addPartByOperatorByCategory(operationType,partName,category);
        }
    }
