package com.cccis.testcase.demo134_140;
...
public class Case140 extends CommonTest {
    LoginPage loginPage;
    ...
    public void addPart(String row, String operationType, String partName) {
        SeleniumUtil.log(log,"----通过配件名称搜索配件" + partName + "，辅料添加应当符合汽修的逻辑 case134----");

        SeleniumUtil.log(log,"----点选添加 空调制冷剂");
        if (row.equals("1")) {
