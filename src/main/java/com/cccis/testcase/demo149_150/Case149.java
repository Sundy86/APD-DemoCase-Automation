...
public class Case149 extends CommonTest {
    LoginPage loginPage;
    ...
    public void addPart(String partName, String operationType) {
        ...
        SeleniumUtil.log(log,"----点选添加换件 左后视镜片");
    ...
    public void preTips(String partName, String row, String columnField, String val ) {
        ...
        Assert.assertEquals(estimateItemPage.getPromptAlertText(), partName + "的换/修金额超过了总成件左后视镜本体(87940-0E040)配件费的100%，请确认是否更换为总成件的换件?");
